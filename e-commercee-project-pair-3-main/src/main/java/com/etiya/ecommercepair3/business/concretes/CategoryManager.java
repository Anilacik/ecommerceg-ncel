...
public class CategoryManager implements CategoryService {
    ...
    @Override
    public List<ListCategoryResponse> getAll1() {
    ...
    public DataResult<CategoryDetailResponse> getCategoryById(Integer id) {
        return new SuccessDataResult<>(categoryDao.getByCategoryId(id),
                messageService.getMessageWithParams(Messages.Category.CategoryGetById,id,LocaleContextHolder.getLocale()));
    }
...
*/
        ...
        return new SuccessDataResult<>(addCategoryResponse,
                messageService.getMessageWithParams(Messages.Category.CategoryAdded,null,LocaleContextHolder.getLocale()));
    }
    ...
    public DataResult<UpdateCategoryResponse> updateCategoryResponse(UpdateCategoryRequest updateCategoryRequest){
        ...
        return new SuccessDataResult<>(updateCategoryResponse,
                messageService.getMessageWithParams(Messages.Category.CategoryUpdated,null, LocaleContextHolder.getLocale()));
    ...
    public Result deleteCategory(Integer id){
        ...
        return new SuccessResult(messageService.getMessageWithParams(Messages.Category.CategoryDeleted,null,LocaleContextHolder.getLocale()));
    }
}
